...
//        CompoundTag compoundTag = new CompoundTag();
    ...
    private void handleItemNotFound()
    {
        ...
        {
            ChickensMod.LOGGER.error("Could not find specfied Item: [" + this.itemID + "]" + (this.hasSource() ? " | Source: [" + this.getSource() + "]" : "") + " | Dropping Default Item: [" + this.stack.getDisplayName() + "]");
            if (ErroredItems.get(this.itemID) == 3)
